...
/*========================RETRIEVAL============================*/    
    public Cursor getData(String table_name) throws SQLException{
    	 //Retrieve all data!
    	openDataBase();
    ...
    public Cursor getRecord(String table_name, String id)
    {
    	openDataBase();
    	return databaseConnect.rawQuery("SELECT * FROM "+table_name+ " where _id = '"+id+"'", null);
    }
    
    public Cursor getPatientSchedule(String id)
    {
    	openDataBase();
