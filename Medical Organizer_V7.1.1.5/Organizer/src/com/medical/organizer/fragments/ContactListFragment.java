...
public class ContactListFragment extends ListFragment implements TextWatcher {
	...
	private void viewContactDetails(final Contacts contact)
	{
		...
		TextView fname = (TextView) info.findViewById(R.id.firstname_info);
		TextView number = (TextView) info.findViewById(R.id.contactnumber_info);
		TextView lname = (TextView) info.findViewById(R.id.lastname_info);
	...
	{	
		...
		ContactAdapter contactAdapter = new ContactAdapter(getActivity(), R.layout.contact_list_item_fragment, master_list);
