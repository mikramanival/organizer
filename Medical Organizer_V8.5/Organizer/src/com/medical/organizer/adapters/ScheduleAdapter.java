...
public class ScheduleAdapter extends ArrayAdapter<Schedule> implements SectionIndexer {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView event_rem = (TextView) convertView.findViewById(R.id.title_header);
		event_rem.setText(s.toString());
		ImageView alarm = (ImageView) convertView.findViewById(R.id.alarm_clock);
		TextView sched_id = (TextView) convertView.findViewById(R.id.id);
