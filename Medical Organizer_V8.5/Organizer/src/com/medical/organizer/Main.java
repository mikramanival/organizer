...
import com.medical.organizer.utilities.NotifyReceiver;
...
public class Main extends Activity {
	...
	private NotifyReceiver reciever = new NotifyReceiver();
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		registerReceiver(reciever, inFil);
...
class MyTabListener implements ActionBar.TabListener{
	...
	public void onTabReselected(Tab tab, FragmentTransaction ft) {
		//Toast.makeText(gAct, "Reselected!", Toast.LENGTH_SHORT).show();
		Log.d("Tabs","Reselected");
	}
